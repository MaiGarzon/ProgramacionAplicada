...
##Marca error debido a que una lista no puede ser una palabra clave:
# powers = {[1, 2, 4, 8, 16]: 2, [1, 3, 9, 27, 81]: 3}
# # print(powers)

##Es valido que los argumentos sean listas, pero no es valido que las palabras clave sean listas.
